...
import com.facebook.airlift.bytecode.control.DoWhileLoop;
import com.facebook.airlift.bytecode.control.FlowControl;
import com.facebook.airlift.bytecode.control.ForLoop;
import com.facebook.airlift.bytecode.control.IfStatement;
import com.facebook.airlift.bytecode.control.SwitchStatement;
import com.facebook.airlift.bytecode.control.TryCatch;
import com.facebook.airlift.bytecode.control.WhileLoop;
import com.facebook.airlift.bytecode.debug.DebugNode;
import com.facebook.airlift.bytecode.debug.LineNumberNode;
import com.facebook.airlift.bytecode.debug.LocalVariableNode;
...
import com.facebook.airlift.bytecode.instruction.Constant.BooleanConstant;
import com.facebook.airlift.bytecode.instruction.Constant.BoxedBooleanConstant;
import com.facebook.airlift.bytecode.instruction.Constant.BoxedDoubleConstant;
import com.facebook.airlift.bytecode.instruction.Constant.BoxedFloatConstant;
import com.facebook.airlift.bytecode.instruction.Constant.BoxedIntegerConstant;
import com.facebook.airlift.bytecode.instruction.Constant.BoxedLongConstant;
import com.facebook.airlift.bytecode.instruction.Constant.ClassConstant;
import com.facebook.airlift.bytecode.instruction.Constant.DoubleConstant;
import com.facebook.airlift.bytecode.instruction.Constant.FloatConstant;
import com.facebook.airlift.bytecode.instruction.Constant.IntConstant;
import com.facebook.airlift.bytecode.instruction.Constant.LongConstant;
import com.facebook.airlift.bytecode.instruction.Constant.StringConstant;
import com.facebook.airlift.bytecode.instruction.FieldInstruction;
import com.facebook.airlift.bytecode.instruction.FieldInstruction.GetFieldInstruction;
import com.facebook.airlift.bytecode.instruction.FieldInstruction.PutFieldInstruction;
import com.facebook.airlift.bytecode.instruction.InstructionNode;
import com.facebook.airlift.bytecode.instruction.InvokeInstruction;
import com.facebook.airlift.bytecode.instruction.InvokeInstruction.InvokeDynamicInstruction;
import com.facebook.airlift.bytecode.instruction.JumpInstruction;
...
import com.facebook.airlift.bytecode.instruction.VariableInstruction.IncrementVariableInstruction;
import com.facebook.airlift.bytecode.instruction.VariableInstruction.LoadVariableInstruction;
import com.facebook.airlift.bytecode.instruction.VariableInstruction.StoreVariableInstruction;
